<div class="page-header">
    <div><h1>Nueva propiedad</h1></div>
    <a class="btn btn--ghost" href="<?= e(url('/properties')) ?>">← Volver</a>
</div>
<section class="panel">
    <form method="post" action="<?= e(url('/properties')) ?>" class="stack">
        ...
        <div class="form-grid">
            ...
            <label>DirecciÃ³n <input name="address" value="<?= e((string) old('address')) ?>"></label>
            <label>Moneda <input name="currency" maxlength="3" value="<?= e((string) (old('currency') ?: 'ARS')) ?>"></label>
            <label>mÂ² <input name="area_m2" type="number" step="0.01" value="<?= e((string) old('area_m2')) ?>"></label>
            <label>Ambientes <input name="rooms" type="number" value="<?= e((string) old('rooms')) ?>"></label>
        </div>
        <label>DescripciÃ³n <textarea name="description"><?= e((string) old('description')) ?></textarea></label>
